...
from keras.layers import Input, Dense, Masking, Convolution1D, TimeDistributed, Bidirectional, Embedding, Dropout, Flatten, concatenate, CuDNNGRU
...
np.save('../../data/result_ter_glove_cnn', 
