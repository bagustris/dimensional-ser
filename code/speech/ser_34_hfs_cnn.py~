...
# 2020-01-10: update to CNN version
...
from keras.layers import Input, Dense, Masking, CuDNNLSTM, TimeDistributed, \
                         ...
                         RNN, concatenate, Activation, Convolution1D
...
# reshape to feat CNN input
feat = feat.reshape(10039, 68, 1)
...
np.save('../../data/predict_ser_34_hfs_cnn', 
